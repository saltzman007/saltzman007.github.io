...
/***/ (function(module, exports, __webpack_require__) {
    ...
    window.formatGoogleCalendar = function () {
        ...
        var formatDateSameDay = function formatDateSameDay(dateStart, dateEnd, dayNames, moreDaysEvent, isAllDayEvent) {
            ...
            var startdayformatted = dateStart[0];
            startdayformatted = (startdayformatted < 10 ? '0' : '') + startdayformatted;
            var startmonthformatted = dateStart[1];
            startmonthformatted = (startmonthformatted < 10 ? '0' : '') + startmonthformatted;

            return startdayformatted + '.' + startmonthformatted + '.' + dateStart[2] + formattedTime;
        };
